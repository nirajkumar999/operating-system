...
#include<vector>
using namespace std;
// Process class containing info about all the process
class Process
{
private:
...
{
if(p1->getRemainingBurstTime()!= p2-
>getRemainingBurstTime())
 return p1->getRemainingBurstTime() < p2-
>getRemainingBurstTime();
...
{
int time_counter=0;
//Using container Vector form C++ Stl
